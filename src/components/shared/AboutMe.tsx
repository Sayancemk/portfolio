        ...
        <div className="w-full relative pt-8 lg:pt-0" id='about-me'>
            ...
            <div className="flex flex-nowrap md:flex-wrap items-center justify-center w-full">
                ...
                <div className="w-full lg:w-[50%]"> 
                    ...
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Name: </strong><span className="text-gray-200"> Sayan Maity</span></p>
                    ...
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Location: </strong><span className="text-gray-200"> New York City, US</span></p>
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Email: </strong><span className="text-gray-200"> sayansed4@sayanmaity.tech</span></p>
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Phone: </strong><span className="text-gray-200"> +91 8900000000</span></p>
                    <p className="text-center my-2"><strong className="font-bold mr-2 text-white">Name: </strong><span className="text-gray-200"> Sayan Maity</span></p>
                </div>
            </div>
        </div>
